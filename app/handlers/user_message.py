...
async def channel(callback: CallbackQuery):
    ...
    #                       show_alert=True)
    await callback.message.edit_text("""Мастерская - закрытый канал, в котором я собрал все свои знания о скейтбординге для начального и базового уровня катания🙏

Канал представляет из себя сборник полезных видео и постов, путешествуя по которым вы будете постепенно находить для себя все новые полезные нюансы, навыки и элементы в трюках💪""",
...
async def cancel_subscription(callback: CallbackQuery):
    ...
    await callback.message.edit_text(f"""Мастерская - закрытый канал, в котором я собрал все свои знания о скейтбординге для начального и базового уровня катания🙏
